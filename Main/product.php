  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <ul>
          ...
          <li><a class="nav-link scrollto" href="index.php#about">About Paper</a></li>
          <li><a class="nav-link scrollto " href="index.php#story">Our Story</a></li>          
          <li><a class="nav-link scrollto " href="index.php#services">Services</a></li>
          <li><a class="nav-link scrollto" href="index.php#products">Gallery</a></li>          
          <li><a class="nav-link scrollto" href="index.php#product.php">Shop</a></li>
