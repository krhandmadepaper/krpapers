            ...
            <div class="card-body">
              <a href="add_stock.php">
                <i class='fas fa-dolly'></i>
                  <h5 class="card-title">
                    <a href="available_data.php">View available Stock</a>
                  </h5>
          ...
          <div class="card" style="white">
            <div class="card-body">
              <i class='far fa-clipboard'></i>
                <h5 class="card-title">
                  <a href="daily_data_view.php">View Daily Data</a>
                </h5>
        ...
        <div class="col-xl-6">
          <div class="card" style="background: white">
            <div class="card-body">
                <i class='fas fa-dolly'></i>
                <h5 class="card-title" >
                  <a href="add_incoming_raw_material.php">Add Incoming Stock</a>
                </h5>
                <!-- <a href="add_incoming_raw_material.php" class="btn btn-primary">Open</a> -->
            </div>
          </div>
        </div>
      </div>
