                        ...
                        <div class="row justify-content-center ">
                            ...
                            <div class="col-lg-8 ">
                                <div class="contact-wrap">
                                    <h1 class="mb-12 text-center" style="font-family:">Update an Existing Supplier</h1>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 lab">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="pname" class="form-control" style="background-color:RGB(190, 157, 147 )" placeholder="Name" required disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 lab">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="packof" class="form-control" style="background-color:RGB(190, 157, 147 )" placeholder="product" required disabled>
                                                </div>
                                            </div>
